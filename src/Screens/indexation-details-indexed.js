import {
  ...
  export default function IndexationDetailsIndexed({ route, navigation }) {
                    ...
                    <View style={[styles.samplesContainer]}>
                      <View style={[{ flex: 1 }]}>
                        <View style={[styles.listHeader]}>
                          ...
                          {indexation.eye == 'RIGHT' ? 'OD' : 'OG'} (Oeil {indexation.eye == 'RIGHT' ? 'droit' : 'gauche'})
                          </Text>
                        </View>
                        <View
